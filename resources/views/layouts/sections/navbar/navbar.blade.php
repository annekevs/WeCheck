    ...
    <div class="{{$containerNav}}">
      ...
      <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
        <a href="{{url('/')}}" class="app-brand-link gap-2">
          <span class="app-brand-logo demo">
            <img src="{{ asset('assets/img/icons/brands/webreathe.PNG') }}" alt class="w-px-40 h-auto rounded-circle">
          </span>
      ...
      <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <div class="navbar-nav align-items-center">
          <div class="nav-item d-flex align-items-center m-0">
            {{-- <i class="bx bx-search bx-md"></i>
            <input type="text" class="form-control border-0 shadow-none ps-1 ps-sm-2" placeholder="Search..."
              aria-label="Search..."> --}}
            <span> Bonjour <span class="text-primary"> ADMIN </span> </span>
          </div>
        </div>
        <!-- /Search -->
          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                <img src="{{ asset('assets/img/avatars/profile_user2.jpg') }}" alt
